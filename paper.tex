...
\clearpage
\section{Background}
We first give a short introduction to implicit parametric models and likelihood-free inference. We then provide the necessary background on two of these methods: Optimisation Monte Carlo (OMC) and its recent robust generalisation, robust OMC (ROMC).
