...
with the \pkg{ELFI~0.8.4} package. The experiments have been executed
in a single machine with an \proglang{Intel® Core™ i7-8750H} Processor
an with \proglang{Ubuntu 20.04} lts operating system.
