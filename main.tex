...
\input{latex_files/ch1/1_1_motivation.tex}
\input{latex_files/ch2/2_1_simulator_based_models.tex}
...
\input{latex_files/ch2/2_2_ROMC.tex}
\input{latex_files/ch2/2_3_ROMC_algorithmic.tex}

\subsection{Engine for likelihood-free inference (ELFI)}
%% 2.4
\input{latex_files/ch2/2_4_ELFI.tex}
