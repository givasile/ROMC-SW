...
\begin{figure}[H]
    \begin{center}
\includegraphics[width=0.8\textwidth]{./latex_files/graphs/ROMC.png}
    \end{center}
...
implementation. The ground-truth posterior approximated
computationally is shown in figure~\ref{fig:example_gt}.
