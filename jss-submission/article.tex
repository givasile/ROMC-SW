...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.49\textwidth]{images/chapter3/example_gt.pdf}
    \includegraphics[width=0.49\textwidth]{images/chapter3/example_posterior.pdf}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.49\textwidth]{./images/chapter4/exec_time_solve.pdf}
    \includegraphics[width=0.49\textwidth]{./images/chapter4/exec_time_regions.pdf}
    \end{center}
